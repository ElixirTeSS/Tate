    ...
    module AnnotationValue #:nodoc:
      ...
      module SingletonMethods
        ...
        def with_attribute_names attributes
          ...
          annotations = Tate::Annotation.with_attribute_names(attributes).with_value_type(self.name).include_values.collect{|ann| ann.value}
          seeds = Tate::AnnotationValueSeed.with_attribute_names(attributes).with_value_type(self.name).include_values.collect{|ann| ann.value}
