...
ActiveRecord::Schema.define(version: 20151029115336) do
  ...
  add_index "tate_annotation_attributes", ["name", "identifier"], name: "index_tate_annotation_attributes_on_name_and_identifier"
